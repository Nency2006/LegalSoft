...
const AdvocateEditForm = ({ advocateId, onClose, fetchAdvocates }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://127.0.0.1:8000/api/advocate/${advocateId}/`)
      .then(res => {
        setFormData({
          ...res.data,
  ...
  const handleSubmit = async e => {
    ...
    try {
      await axios.put(`http://127.0.0.1:8000/api/advocate/${advocateId}/`, data);
      fetchAdvocates();
      onClose();
      ...
      <div className="modal-box large">
        ...
        <form className="modal-form-grid" onSubmit={handleSubmit}>
          ...
          <div className="modal-actions full-width">
            <button type="submit" className="save-btn">Update Advocate</button>
